...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 238.0, 692.0, 65.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 126.0, 473.0, 65.0, 20.0 ],
					"style" : "",
					"text" : "Recorder"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 253.0, 592.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 103.0, 471.0, 21.0, 21.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 279.0, 608.0, 37.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 59.5, 471.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 262.0, 644.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "sfrecord~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 14.0, 196.0, 54.0, 22.0 ],
					"style" : "",
					"text" : "t b b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 14.0, 295.0, 58.0, 22.0 ],
					"style" : "",
					"text" : "grainEnv"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.666666, 263.0, 69.0, 22.0 ],
					"style" : "",
					"text" : "grainBuffer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.0, 225.0, 51.0, 22.0 ],
					"style" : "",
					"text" : "target 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 14.0, 148.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.75, 644.0, 47.0, 22.0 ],
					"style" : "",
					"text" : "dac~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 289.0, 547.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "t b s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 323.5, 517.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "storagewindow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 569.0, 14.0, 122.0, 25.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 723.0, 16.0, 42.0, 34.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 697.0, 14.0, 24.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 922.0, 754.0, 207.0, 36.0 ],
					"style" : "",
					"text" : "recallmulti 1. 2. 3. 4.924907 5. 6. 7. 8."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1048.0, 617.0, 93.0, 38.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"xplace" : [ 0.125, 0.25, 0.11, 0.4, 0.395 ],
					"yplace" : [ 0.165, 0.375, 0.575, 0.155, 0.585 ]
				}
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						"durationRange" : [ 2334, 2334 ],
						"env" : [ 0 ],
						"live.gain~" : [ -14.582677 ],
						"live.gain~[1]" : [ -70.0 ],
						"pitch" : [ 3.0 ],
						"startingRange" : [ 352.85214, 839.544747 ]
					}
,
					"style" : "",
					"text" : "autopattr",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 352.0, 563.0, 257.0, 22.0 ],
...
,
					"style" : "",
					"text" : "pattrstorage breakingPoint.json @savemode 2",
					"varname" : "breakingPoint.json"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 243.0, 282.0, 74.0, 109.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 182.0, 338.0, 50.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 103.0, 198.0, 51.0, 22.0 ],
					"style" : "",
					"text" : "target 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 103.0, 171.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 693.0, 287.0, 173.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 792.75, 187.0, 124.0, 22.0 ],
					"style" : "",
					"text" : "s grainBufferDuration"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 720.0, 122.0, 103.0, 22.0 ],
					"style" : "",
					"text" : "info~ grainBuffer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 697.0, 82.0, 110.0, 22.0 ],
					"style" : "",
					"text" : "buffer~ grainBuffer"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 167.0, 403.0, 113.5, 22.0 ],
					"style" : "",
					"text" : "poly~ grain 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 276.0, 508.0, 35.0, 22.0 ],
					"style" : "",
					"text" : "read"
				}
